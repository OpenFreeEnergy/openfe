...
def gen_transformations(prefix: str, dataset_dir: pathlib.Path, charge_model: str, system_group: str, system_name: str) -> None:
...
dataset_dir = pathlib.Path("/home/mmh/Projects/openfe-benchmarks/openfe_benchmarks/data/industry_benchmark_systems")
...
gen_transformations(prefix=PREFIX, dataset_dir=dataset_dir, charge_model=CHARGE_MODEL, system_group="jacs_set", system_name="tyk2")
gen_transformations(prefix=PREFIX, dataset_dir=dataset_dir, charge_model=CHARGE_MODEL, system_group="jacs_set", system_name="p38")
gen_transformations(prefix=PREFIX, dataset_dir=dataset_dir, charge_model=CHARGE_MODEL, system_group="mcs_docking_set", system_name="hne")
