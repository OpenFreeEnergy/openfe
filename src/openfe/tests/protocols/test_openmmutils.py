...
def _build(benzene_modifications, specs):
    """
    Build a small_mols dict and the alchemical list from a case spec.
    specs is a list of (mol_name, is_ligand, resname, residue_number).
    """
    small, alchemical = {}, []
...
def test_assign_offmol_residue_metadata(benzene_modifications, specs, expected):
    small, alchemical = _build(benzene_modifications, specs)
