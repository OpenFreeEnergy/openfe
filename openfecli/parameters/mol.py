...
def _load_molecule_from_smiles(user_input, context):
    ...
    return LigandMolecule(rdkit=mol)
...
def _load_molecule_from_sdf(user_input, context):
    ...
    from openfe.setup import LigandMolecule
    try:
        return LigandMolecule.from_sdf_file(user_input)
...
MOL = Option(
    "--mol",
    help="LigandMolecule. Can be provided as an SDF file or as a SMILES string.",
    getter=get_molecule
)
