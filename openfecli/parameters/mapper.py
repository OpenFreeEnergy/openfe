...
get_atommapper = MultiStrategyGetter(
    ...
    error_message=(
        "Unable to create atom mapper from user input " "'{user_input}'. Please check spelling and " "capitalization."
    ),
)
...
MAPPER = Option(
    ...
    help=("Atom mapper; can either be a name in the openfe.setup namespace " "or a custom fully-qualified name."),
)
