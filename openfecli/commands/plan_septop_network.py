...
#     alchemical_network, ligand_network = plan_septop_network_main(
#         mapper=[mapper_obj],
#         mapping_scorer=mapping_scorer,
#         ligand_network_planner=ligand_network_planner,
...
PLUGIN = OFECommandPlugin(
    command=plan_septop_network, section="Network Planning", requires_ofe=(0, 3)
)
