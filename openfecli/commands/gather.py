...
def gather(
    ...
    Walks RESULTS paths recursively and finds all result JSON files generated by ``openfe quickrun``
    (these files must end in .json to be collected!).
    Each JSON contains the results of a separate leg from a relative free energy thermodynamic cycle.
