...
def format_estimate_uncertainty(
    ...
    On the other hand, if you wanted to report your uncertain to the first significant figure (0.01), then you should report your estimate as 12.35.
    ...
    The uncertainty is presented to the desired number of significant figures.
