...
html_theme_options = {
    ...
    "announcement": "The OpenFE team is conducting user interviews until August 15th! <a href=https://app.reclaim.ai/m/james-omsf/openfe-user-interview>Click here to schedule an interview.</a>",
}
